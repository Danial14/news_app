...
class LargeDevicesWebViewHome extends StatefulWidget {
  const LargeDevicesWebViewHome({Key? key}) : super(key: key);

  @override
  State<LargeDevicesWebViewHome> createState() => _LargeDevicesWebViewHomeState();
}

class _LargeDevicesWebViewHomeState extends State<LargeDevicesWebViewHome> {
